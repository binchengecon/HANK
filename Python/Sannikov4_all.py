...
while FC_Err > tol and epoch < max_iter:
    ...
    dFdW1,ddFddW1,F_init_new = finiteDiff_3D(F_init, 0, 1, hW1)
    F_init = F_init_new
    ...
    PDE_rhs = A * F_init + B_1 * dFdW1 + C_1 * ddFddW1 + D
...
with open(Data_Dir + f"model_result4_all_{max_iter}", "wb") as f:
    pickle.dump(res, f)
