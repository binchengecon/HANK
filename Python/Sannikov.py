...
while FC_Err > tol and epoch < max_iter:
    ...
    # dW1[dW1 <= 1e-16] = 1e-16
    # dK = dW1
    dFdW2  = finiteDiff_3D(F_init,1,1,hW2)
    # dY = dW2
    dFdW3  = finiteDiff_3D(F_init,2,1,hW3)
    # dW3[dW3 <= 1e-16] = 1e-16
    # dL = dW3
    ######## second order
    ...
    if np.all(dFdW1+ddFddW1* r *sigma**2>=0):
        print("warning\n")
    a_new = -1/(dFdW1+ddFddW1* r *sigma**2)-0.4
    ...
    petsclinearsystem.formLinearSystem(W1_mat_1d, W2_mat_1d, W3_mat_1d, A_1d, B_1_1d, B_2_1d, B_3_1d, C_1_1d, C_2_1d, C_3_1d, epsilon, lowerLims, upperLims, dVec, increVec, petsc_mat)
    ...
    PDE_rhs = A * F_init + B_1 * dFdW1 + B_2 * dFdW2 + B_3 * dFdW3 + C_1 * ddFddW1 + C_2 * ddFddW2 + C_3 * ddFddW3 + D
