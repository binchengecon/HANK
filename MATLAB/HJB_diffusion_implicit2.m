...
updiag=repmat(zeta(1),I,1); %This is necessary because of the peculiar way spdiags is defined.
for j=2:J
    updiag=[updiag;repmat(zeta(j),I,1)];
end
...
%     updiag=[Z(1:I-1,1)]; %This is needed because of the peculiarity of spdiags.
%     for j=2:J
